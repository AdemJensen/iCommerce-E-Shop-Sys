...
//        }
        ...
        try {
            ...
            try {
                ...
                PreparedStatement state = database.database.prepareStatement("CREATE DATABASE IF NOT EXISTS `" + DATABASE_SCHEMA + "` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;");
                state.executeUpdate();
                ...
                state.executeUpdate();
                state = database.database.prepareStatement("/*!40000 ALTER TABLE `" + conf.DATABASE_TABLE_ADMIN + "` DISABLE KEYS */;");
                state.executeUpdate();
                ...
                state.executeUpdate();
                state = database.database.prepareStatement("/*!40000 ALTER TABLE `" + conf.DATABASE_TABLE_ADMIN + "` ENABLE KEYS */;");
                state.executeUpdate();
