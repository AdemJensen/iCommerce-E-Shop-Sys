...
public class Add extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            String itemDetailPage = request.getParameter("detail_page");
            double itemOldPrice = Double.parseDouble(request.getParameter("price_old"));
            double itemNewPrice = Double.parseDouble(request.getParameter("price_new"));
            int itemQuantity = Integer.parseInt(request.getParameter("quantity"));
            String[] itemTypeS = request.getParameterValues("add_type");
            ...
            switch (ItemData.addItem(database, itemName, cover, itemDetailPage, itemOldPrice, itemNewPrice, itemQuantity, itemType)) {
                case 0:
