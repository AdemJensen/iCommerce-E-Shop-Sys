...
public class LoginSubmit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            switch (AuthData.customerLogin(database, request.getSession(false), username, password)) {
                case 0:
                ...
                case 3:
                    res_type = "error";
                    res_str = "登录请求被拒绝";
                    res_hint = "用户名或密码错误，请<a href='" + request.getContextPath() + "/login'>点此返回</a>";
                    break;
                case 4:
                    res_type = "error";
                    res_str = "登录请求被拒绝";
                    res_hint = "您所登陆的用户已被封禁，请<a href='" + Request.getLastVis(request) + "'>点此返回</a>";
                    break;
                default:
                    res_type = "error";
                    res_str = "登录失败";
